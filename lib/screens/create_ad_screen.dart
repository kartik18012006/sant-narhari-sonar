...
class _CreateAdScreenState extends State<CreateAdScreen> {
  ...
  // Business documents (image uploads)
  ...
  Future<String?> _uploadDocument(String documentType) async {
    return await ImagePickerService.instance.pickAndUploadImage(
      context: context,
      storagePath: 'advertisements/${FirebaseAuthService.instance.currentUser?.uid ?? 'unknown'}/documents/$documentType',
      maxWidth: 1920,
      maxHeight: 1080,
                            ...
                            child: GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  else if (label.contains('Owner') && label.contains('PAN')) _ownersPanCardImageUrl = null;
                                  ...
                                  else if (label.contains('Business Address Proof')) _businessAddressProofImageUrl = null;
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 12, color: Colors.pink.shade600, fontWeight: FontWeight.w500),
              maxLines: 2,
